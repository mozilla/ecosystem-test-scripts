...
class CircleCIScraper:
    ...
    def export_test_artifacts_workflow_id(
        ...
        while True:
            ...
            for job in jobs.items:
                job_config: CircleCIScraperJobConfig | None = next(
    ...
    def export_artifacts(
        ...
        for index, artifact in enumerate(artifacts):
            job_datetime = datetime.strptime(job.started_at, DATETIME_FORMAT)
            epoch_timestamp = int(job_datetime.timestamp())
